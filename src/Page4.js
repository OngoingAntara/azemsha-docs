...
function Page4() {
  ...
  return (
    <div className='page'>
      <div className='title align_self_center text-align-center'>Профессиональное суждение № <input className='text-font bold small border-none'/><br/>
      по проверке на обесценение нематериальных активов</div>
      <br/>
      <div className='date'>«<input className='small border-bottom cursive text-font'/>»<input className='middle border-bottom cursive text-font'/> 20<input className='small border-bottom cursive text-font'/>года</div>
      <br/>
      <div className='flex_column width-100 margin-07'>
        <div className='align_stretch text-indent'>Наименование оцениваемого основного средства (группы основных средств):</div>
        <div className='width-100'><input className='width-100 border-bottom text-font'/></div>
        <div className='align_stretch'>характеристика нематериального актива:</div>
      </div>
      <br/>
      <ol className='ol-bold'>
        <li className='text-align-justify' ><b>Объект, учитывался в составе</b> (указать нужное):</li>
        <table className='table margin-07'>
          ...
          <tbody>
            <tr>
              <td className='table_body_td'>№ 60901 «Нематериальные активы»</td>
            ...
            <tr>
              <td className='table_body_td'>№ 60905 «Деловая репутация»</td>
              <td className='table_body_td padding-0'><input className='width-100 height-100 padding-0 border-none text-align-center text-font'/></td>
            </tr>
          </tbody>
        </table>
        <br/>
        <li className='text-align-justify' ><b>Балансовая стоимость нематериального актива по состоянию на 31.12.<textarea  placeholder="____" className='text-font bold border-none padding-0 textarea-height middle textarea'/></b> составляет <textarea className='text-font border-bottom padding-0 textarea-height large textarea'/> руб.</li>
        <table className='table margin-07'>
          <thead className='table_head'>
        ...
        <br/>
        <li className='text-align-justify' ><b>Модель учета последующей оценки:</b> По первоначальной стоимости за вычетом накопленной амортизации и накопленных убытков от обесценения (модель учета по фактическим затратам).</li>
        <br/>
        <li className='text-align-justify'><b>Проверка на обесценение (п.12.16. главы 12 №612-п): Возникали ли следующие события в отчетном периоде:</b></li>
        <table className='table margin-07'>
          {/* <thead>
          ...
          <tbody>
            ...
            <tr>
              <td className='table_body_td text-align-justify'>1. Наличие наблюдаемых признаков того, что стоимость нематериального 
              актива снизилась в течение периода значительно больше, 
              чем ожидалось с течением времени или при обычном использовании;</td>
              <td className='table_body_td padding-0'><input className='width-100 height-100 padding-0 border-none text-align-center text-font'/></td>
            </tr>
            <tr>
              <td className='table_body_td text-align-justify'>2. Значительные изменения, имеющие неблагоприятные последствия для организации, 
        ...
        <br/>
        <li className='text-align-justify' ><b>В случае возникновения вышеописанных ситуаций</b>, а также для НМА с неопределенным сроком полезного использования, определена возмещаемая стоимость, 
        как максимальная из ценности использования и справедливой цены за вычетом расходов на продажу.
        </li>
        <li className='text-align-justify' ><b>Ценность использования</b>, рассчитанная как сумма дисконтированных будущих потоков денежных средств от рассматриваемого актива, составляет <textarea className='text-font border-bottom padding-0 textarea-height large textarea'/>руб.</li>
        <table className='table margin-07'>
          <thead className='table_head'>
          ...
          <tbody>
            ...
            <tr>
              <td colSpan={5} className='table_body_td text-align-center'>Ценность использования актива</td>
        ...
        экспертных оценок специалистов на дату оценки составляет <textarea placeholder="XXX" className='text-font border-none padding-0 textarea-height middle textarea'/> руб.<br/>
        </li>
        <br/>
      ...
      <div className='text-align-justify text-font padding-left'>Профессиональное суждение составил <input className='text-font border-bottom ep'/> /должность, подразделение, Ф.И.О./ </div>
